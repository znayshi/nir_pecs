...
class FakeLocalDataSource : LocalDataSource {
    ...
    override suspend fun getPictogram(pictogramId: Int): Card =
        pictogramFromDisk.copy(pictogramId)

    override suspend fun addPictogram(pictogram: Card) = flow {
    ...
    override suspend fun updatePictogram(pictogram: Card) = flow {
    ...
    override suspend fun updatePictograms(pictograms: List<Card>) = flow {
    ...
    override suspend fun deletePictograms(pictograms: List<Card>) = flow {
