package com.cmi.presentation.config.delete.card

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.cmi.domain.usecase.DeleteCardUseCase
import com.cmi.domain.usecase.GetCardByCategoryUseCase
import com.cmi.presentation.Constants
import com.cmi.presentation.config.select.card.SelectPictogramUiState
...
class DeletePictogramViewModel(
    ...
    private val deletePictogramsUseCase: DeleteCardUseCase
) : ViewModel() {
