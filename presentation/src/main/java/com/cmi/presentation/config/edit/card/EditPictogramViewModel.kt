package com.cmi.presentation.config.edit.card
...
import com.cmi.domain.usecase.UpdateCardsUseCase
...
class EditPictogramViewModel(private val updatePictogramUseCase: UpdateCardsUseCase) :
    ViewModel() {
