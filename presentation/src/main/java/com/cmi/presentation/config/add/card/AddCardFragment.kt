package com.cmi.presentation.config.add.card
...
import com.cmi.presentation.common.Pick
...
class AddCardFragment : Pick(), CategoryAdapter.ItemListener {

    private var _binding: FragmentAddPictogramBinding? = null
    private val binding get() = _binding!!

    private val addPictogramViewModel: AddCardViewModel by viewModel {
        parametersOf(
    ...
    private fun loadPictograms(categories: Map<Int, List<CategorySelectableModel>>) =
        with(binding) {
            if (categories.isNotEmpty()) {
                ...
                categoryAdapter?.setListener(this@AddCardFragment)
