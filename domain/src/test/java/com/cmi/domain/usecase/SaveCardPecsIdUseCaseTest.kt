...
class SaveCardPecsIdUseCaseTest {

    private lateinit var savePictogramPecsIdUseCase: SaveCardPecsIdUseCase
    private lateinit var localDataSource: LocalDataSource

    @Before
    fun setUp() {
        localDataSource = FakeLocalDataSource()
        savePictogramPecsIdUseCase = SaveCardPecsIdUseCase(localDataSource)
    }
    ...
    fun `execute save main pictogram pecs id use case`() = runBlocking {
        ...
        savePictogramPecsIdUseCase
            .invoke(
                type = SaveCardPecsIdUseCase.PICTOGRAM_MAIN,
    ...
    fun `execute save first action pictogram pecs id use case`() = runBlocking {
        ...
        savePictogramPecsIdUseCase
            .invoke(
                type = SaveCardPecsIdUseCase.PICTOGRAM_FIRST_ACTION,
                pictogramId = pictogramAdded.pictogramId ?: INVALID_ID
            )
            .single()
    ...
    fun `execute save second action pictogram pecs id use case`() = runBlocking {
        ...
        savePictogramPecsIdUseCase
            .invoke(
                type = SaveCardPecsIdUseCase.PICTOGRAM_SECOND_ACTION,
                pictogramId = pictogramAdded.pictogramId ?: INVALID_ID
            )
            .single()
    ...
    fun `execute save attribute pictogram pecs id use case`() = runBlocking {
        ...
        savePictogramPecsIdUseCase
            .invoke(
                type = SaveCardPecsIdUseCase.PICTOGRAM_ATTRIBUTE,
                pictogramId = pictogramAdded.pictogramId ?: INVALID_ID
            )
            .single()
    ...
    fun `execute save second attribute pictogram pecs id use case`() = runBlocking {
        ...
        savePictogramPecsIdUseCase
            .invoke(
                type = SaveCardPecsIdUseCase.PICTOGRAM_SECOND_ATTRIBUTE,
                pictogramId = pictogramAdded.pictogramId ?: INVALID_ID
            )
            .single()
